 ...
 *  Author: TUTK
 *
 *  2012-08-07 - Add video width and height to FRAMEINFO_t 11;
 */

#ifndef _AVFRAME_INFO_H_
#define _AVFRAME_INFO_H_

/////流解析中增加返回时间戳，用于显示水印（由于竖屏水印只能竖着，故由App做水印渲染，正常设备去掉该宏）
//#ifndef ADD_TIMESTAMP
...
#ifdef ADD_TIMESTAMP
    unsigned long timestamp2;    // (竖屏版使用，为了传出时间戳用于显示水印)Timestamp of the frame, in milliseconds
#endif
