 ...
 * \attention "Only" Device needs to use this API.
 */
P2PAPI_API_DEPRECATED int32_t IOTC_WakeUp_Get_KeepAlivePacket(IOTC_WakeUpData **pData, uint32_t *pDataCnt);
 ...
 * \attention "Only" Device needs to use this API.
 */
P2PAPI_API int32_t IOTC_WakeUp_Get_SleepPacket2(IOTC_WakeUp_SleepPacketCB fptrReadyForSleepingCB, int32_t nTimeoutMs);
